...
var MessagesValidationFormComponent = (function () {
    function MessagesValidationFormComponent() {
        this.hero = { name: 'liu feifei', age: 3 };
        this.active = true;
        this.formErrors = {
            'name': '',
            'age': ''
    ...
    MessagesValidationFormComponent.prototype.ngAfterViewChecked = function () {
        this.formChanged();
    };
    MessagesValidationFormComponent.prototype.formChanged = function () {
        var _this = this;
    ...
    MessagesValidationFormComponent.prototype.onValueChanged = function (data) {
        if (!this.heroForm) {
            return;
        }
    ...
    MessagesValidationFormComponent.prototype.ok = function () {
        console.log('haha');
        console.log(this.heroForm);
    };
    return MessagesValidationFormComponent;
}());
__decorate([
    core_1.ViewChild('heroForm'),
    __metadata("design:type", forms_1.NgForm)
], MessagesValidationFormComponent.prototype, "currentForm", void 0);
MessagesValidationFormComponent = __decorate([
    core_1.Component({
        selector: 'test-form',
        template: __webpack_require__(370)
    })
], MessagesValidationFormComponent);
exports.MessagesValidationFormComponent = MessagesValidationFormComponent;
...
Object.defineProperty(exports, "__esModule", { value: true });
var core_1 = __webpack_require__(13);
var phrase_service_1 = __webpack_require__(73);
var router_1 = __webpack_require__(94);
__webpack_require__(167);
var PhraseComponent = (function () {
    function PhraseComponent(phraseService, route, router) {
    ...
    PhraseComponent.prototype.ngOnInit = function () {
        ...
        var id = this.route.params.subscribe(function (params) {
            _this.showMeaning = false;
            _this.showAddExample = false;
            _this.showNext = false;
            _this.phraseService.getPhrase(params['id']).then(function (data) {
                _this.phrase = data;
                _this.play();
            });
        });
    };
    PhraseComponent.prototype.play = function () {
        var _this = this;
        this.audio.onended = function () {
            _this.audio.onended = null;
            if (_this.phrase.sentences.length) {
                _this.audio.src = 'http://dict.youdao.com/dictvoice?audio=' + _this.phrase.sentences[0] + '&type=2';
                _this.audio.play();
            }
        };
        var phrase = this.phrase.phrase;
        this.audio.pause();
        this.audio.src = 'http://dict.youdao.com/dictvoice?audio=' + phrase + '&type=2';
        this.audio.play();
    };
    PhraseComponent.prototype.onKey = function (event) {
    ...
    PhraseComponent.prototype.remember = function () {
        this.next();
    };
    PhraseComponent.prototype.next = function () {
        this.ngOnInit();
    };
    PhraseComponent.prototype.addExample = function () {
        this.phraseService.insertExample(this.phrase.phrase_id, this.example).then(function (data) {
            console.log(data);
        });
    };
...
var SentenceComponent = (function () {
    function SentenceComponent(phraseService) {
        this.phraseService = phraseService;
        this.vocabularies = ['The potato was hot, so I fumbled and dropped it.haha',
    ...
    SentenceComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.phraseService.getAllSentence().then(function (data) {
            _this.vocabularies = data;
        });
    };
    SentenceComponent.prototype.play = function (phrase) {
        this.audio.pause();
        this.audio.src = "http://dict.youdao.com/dictvoice?audio=" + phrase + "&type=2";
        this.audio.play();
        return false;
...
exports.SentenceComponent = SentenceComponent;
...
var core_1 = __webpack_require__(13);
var forms_1 = __webpack_require__(96);
var SimpleValidationFormComponent = (function () {
    function SimpleValidationFormComponent() {
        this.hero = { name: 'liu feifei', age: 3 };
        this.active = true;
    }
    SimpleValidationFormComponent.prototype.ngAfterViewChecked = function () {
        this.formChanged();
    };
    SimpleValidationFormComponent.prototype.formChanged = function () {
        if (this.currentForm === this.heroForm) {
            return;
        }
        this.heroForm = this.currentForm;
    ...
    SimpleValidationFormComponent.prototype.ok = function () {
        console.log(this.heroForm);
    };
    return SimpleValidationFormComponent;
}());
__decorate([
    core_1.ViewChild('heroForm'),
    __metadata("design:type", forms_1.NgForm)
], SimpleValidationFormComponent.prototype, "currentForm", void 0);
SimpleValidationFormComponent = __decorate([
    core_1.Component({
        selector: 'test-form',
        template: __webpack_require__(373)
    })
], SimpleValidationFormComponent);
exports.SimpleValidationFormComponent = SimpleValidationFormComponent;
...
var WordListComponent = (function () {
    function WordListComponent(phraseService) {
        this.phraseService = phraseService;
        this.allPhrases = [];
    }
    WordListComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.phraseService.getAllPhrases().then(function (data) {
            _this.allPhrases = data;
        });
    };
...
var phrase_component_1 = __webpack_require__(130);
var sentence_component_1 = __webpack_require__(131);
var word_list_component_1 = __webpack_require__(133);
var phrase_service_1 = __webpack_require__(73);
var app_routes_1 = __webpack_require__(214);
var simple_validation_form_component_1 = __webpack_require__(132);
var messages_validation_form_component_1 = __webpack_require__(129);
...
AppModule = __decorate([
    core_1.NgModule({
        ...
        declarations: [
            ...
            sentence_component_1.SentenceComponent,
            word_list_component_1.WordListComponent,
            simple_validation_form_component_1.SimpleValidationFormComponent,
            messages_validation_form_component_1.MessagesValidationFormComponent
        ],
        providers: [
...
var AppComponent = (function () {
    function AppComponent() {
        this.title = 'My New Vocabularies';
    }
...
var messages_validation_form_component_1 = __webpack_require__(129);
var appRoutes = [
    { path: 'phrase/:id', component: phrase_component_1.PhraseComponent },
    { path: 'allphrases', component: word_list_component_1.WordListComponent },
    { path: 'sentence', component: sentence_component_1.SentenceComponent },
    { path: 'simplevalidation', component: simple_validation_form_component_1.SimpleValidationFormComponent },
    { path: 'messagesvalidation', component: messages_validation_form_component_1.MessagesValidationFormComponent },
...
module.exports = "<!--<ribbon-bar [tabs]=\"myTabs\" [items]=\"myItems\">\r\n</ribbon-bar>-->\r\n<div class=\"container\">\r\n  <div class=\"header\">\r\n    <h3 class=\"text-muted\">{{title}}</h3>\r\n  </div>\r\n  <div class=\"jumbotron\">\r\n    <router-outlet></router-outlet>\r\n  </div>\r\n  <div class=\"footer\">\r\n    <p>&copy; Feifei 2016</p>\r\n  </div>\r\n</div>\r\n<!-- /container -->";
...
module.exports = "<h1>Template-Driven Forms with validation messages in code</h1>\r\n<form #heroForm=\"ngForm\" *ngIf=\"active\" (ngSubmit)=\"onSubmit()\">\r\n    <div class=\"form-group\">\r\n        <label for=\"name\">Name</label>\r\n        <input type=\"text\" class=\"form-control\" id=\"name\" [(ngModel)]=\"hero.name\" name=\"name\" required minlength=\"9\"\r\n            maxlength=\"20\" width=\"50%\">\r\n        <div *ngIf=\"formErrors.name\" class=\"alert alert-danger\">\r\n            {{ formErrors.name }}\r\n        </div>\r\n    </div>\r\n    <div class=\"form-group\">\r\n        <label for=\"age\">Age</label><br>\r\n        <input type=\"number\" step=\"1\" min=\"1\" max=\"120\" id=\"age\" pattern=\"[0-9]{1,3}\" [(ngModel)]=\"hero.age\" name=\"age\" required >\r\n        <div *ngIf=\"formErrors.age\" class=\"alert alert-danger\">\r\n            {{ formErrors.age }}\r\n        </div>\r\n    </div>\r\n    <button class=\"btn btn-default\" (click)=\"ok()\" [disabled]=\"!heroForm.form.valid\">OK</button>\r\n</form>";
...
module.exports = "<div class=\"row\">\r\n  <div class=\"col\">\r\n    <div ngbDropdown class=\"d-inline-block\">\r\n      <button class=\"btn btn-outline-primary\" id=\"dropdownMenu1\" ngbDropdownToggle>Toggle dropdown</button>\r\n      <div class=\"dropdown-menu\" aria-labelledby=\"dropdownMenu1\">\r\n        <button class=\"dropdown-item\">Action - 1</button>\r\n        <button class=\"dropdown-item\">Another Action</button>\r\n        <button class=\"dropdown-item\">Something else is here</button>\r\n      </div>\r\n    </div>\r\n  </div>\r\n</div>\r\n\r\n<div (keyup)=\"onKey($event)\">\r\n\t<h2 class=\"text-center\">{{phrase.phrase}}</h2>\r\n\t<h2 class=\"text-center\" style=\"color:gray;dispaly:inline-block;\">{{phrase.phonetic}}\r\n\t\t<a href=\"#\" onclick='return false;' (click)=\"play();\">\r\n\t\t\t<span class=\"glyphicon glyphicon-volume-up\"></span>\r\n\t\t</a>\r\n\t</h2>\r\n\t<br>\r\n\t<div [hidden]=\"!showMeaning\">\r\n\t\t{{phrase.meaning}}\r\n\t</div>\r\n\t<ul class=\"list-group\" [hidden]=\"!showMeaning\">\r\n\t\t<li class=\"list-group-item\" *ngFor=\"let sentence of this.phrase.sentences\">\r\n\t\t\t{{sentence}}\r\n\t\t</li>\r\n\t</ul>\r\n\r\n\t<div class=\"text-center\">\r\n\t\t<div [hidden]=\"showNext\">\r\n\t\t\t<button class=\"btn btn-info\" (click)=\"remember()\">I remember</button>\r\n\t\t\t<button class=\"btn btn-info\" (click)=\"showMeaning=!showMeaning;showNext=!showNext;\">I forget</button>\r\n\t\t</div>\r\n\t\t<h2 style=\"dispaly:inline-block;\">\r\n\t\t\t<a href=\"#\" [hidden]=\"!showNext\" onclick=\"return false;\" (click)=\"next()\">\r\n\t\t\t\t<span class=\"glyphicon glyphicon-arrow-right\"></span>\r\n\t\t\t</a>\r\n\t\t</h2>\r\n\t</div>\r\n\r\n\t<br>\r\n\t<br>\r\n\t<div [hidden]=\"!showAddExample\"> \r\n\t\t<textarea [(ngModel)]=\"example\"></textarea >\r\n    <br>\r\n    <button class=\"btn btn-info\" (click)=\"addExample()\">add example to this phrase</button>\r\n\t</div>\r\n</div>";
...
module.exports = "<h1>My Vocabularies</h1>\r\n<ol>\r\n    <li *ngFor=\"let vocabulary of vocabularies\">\r\n        <span>{{vocabulary}}</span>\r\n        <a href=\"#\" (click)=\"play(vocabulary)\" (mouseover)=\"play(vocabulary)\"><img src=\"{{icon}}\" alt=\"\"></a>\r\n    </li>\r\n</ol>";
...
module.exports = "<table>\r\n    <tr>\r\n        <th>Word</th>\r\n        <th>phonetic</th>\r\n        <th>Meaning</th>\r\n        <th>Update Date</th>\r\n    </tr>\r\n    <tr *ngFor=\"let phrase of allPhrases\">\r\n        <td> {{phrase.phrase}}</td>\r\n        <td>{{phrase.phonetic}}</td>\r\n        <td>{{phrase.meaning}}</td>\r\n        <td>{{phrase.update_time}}</td>\r\n    </tr>\r\n</table>";
...
platform_browser_dynamic_1.platformBrowserDynamic().bootstrapModule(app_module_1.AppModule).then(function (sucess) {
    console.log('bootstrap success.');
}).catch(function (err) { return console.error(err && err.message); });
...
var PhraseService = (function () {
    function PhraseService(http) {
        this.http = http;
        this.phraseUrl = 'api/v1/phrase/';
        this.allSentenceUrl = 'api/v1/allSentence';
        this.allPhraseUrl = 'api/v1/allphrases';
    }
    PhraseService.prototype.getPhrase = function (id) {
        return this.http.get(this.phraseUrl + id).toPromise().then(function (r) { return r.json(); });
    };
    PhraseService.prototype.getAllSentence = function () {
        return this.http.get(this.allSentenceUrl).toPromise().then(function (r) { return r.json(); });
    };
    PhraseService.prototype.getAllPhrases = function () {
        return this.http.get(this.allPhraseUrl).toPromise().then(function (r) { return r.json(); });
    };
    PhraseService.prototype.insertExample = function (phraseId, example) {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_rxjs_observable_fromPromise__ = __webpack_require__(120);
